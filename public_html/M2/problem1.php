...
function processArray($arr) {
    ...
    for($i=0; $i<count($arr); $i++){        //for loop go through each number
        if($arr[$i]%2 != 0){                //if statment to check if the remainder is not 0 then it is odd number
            echo $arr[$i].", ";             // prints the number 
        }
     }
